...
var url_r = 'http://'+IP_address+'/PROJECT/OneByOne/roll_deg.json';		//roll json data
var url_p = 'http://'+IP_address+'/PROJECT/OneByOne/pitch_deg.json'; 		//pitch json data
var url_y = 'http://'+IP_address+'/PROJECT/OneByOne/yaw_deg.json';			//yaw json data
...
url_r = 'http://'+newIP+'/PROJECT/OneByOne/roll_deg.json';		//roll json data
url_p = 'http://'+newIP+'/PROJECT/OneByOne/pitch_deg.json'; 		//pitch json data
url_y = 'http://'+newIP+'/PROJECT/OneByOne/yaw_deg.json';			//yaw json data
...
function ajaxJSON() {
	$.ajax(url_r, {
		type: 'GET', dataType: 'json', 
		success: function(responseJSON, status, xhr) {
			roll = +responseJSON.value;
	$.ajax(url_p, {
		type: 'GET', dataType: 'json', 
		success: function(responseJSON, status, xhr) {
			pitch = +responseJSON.value;		
	$.ajax(url_y, {
		type: 'GET', dataType: 'json', 
		success: function(responseJSON, status, xhr) {
			addData(roll,pitch, +responseJSON.value);
		}	
	});
		}
	});	
...
$(document).ready(() => { 
	...
	$("#btn").click(()=>{
		...
		sampleTimeSec = parseFloat(document.getElementById("sampleTimeInput").value);
		$("#samplenumber").text(maxSamplesNumber.toString());
